...

    {
      ...
      bcrypt =
        ...
        super.bcrypt.overridePythonAttrs (old: {
          nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++
            lib.optionals (lib.versionAtLeast old.version "4") (with pkgs.rustPlatform; [
              cargoSetupHook
              rust.cargo
              rust.rustc
      ...
      cloudflare = super.cloudflare.overridePythonAttrs (_: {
        postPatch = ''
          rm -rf examples/*
        '';
      });
      ...
      coincurve = super.coincurve.overridePythonAttrs (_: {
        # package setup logic
      ...
      cryptography =
        ...
        scrypto.overridePythonAttrs (old: {
          nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ lib.optionals (!self.isPyPy) [
            pyBuildPackages.cffi
      ...
      dbus-python = super.dbus-python.overridePythonAttrs (old: {
        ...
        buildInputs = (old.buildInputs or [ ]) ++ [
          pkgs.dbus
          pkgs.dbus-glib
        ] ++ lib.optionals (! self.python ? modules) [
      ...
      h5py =
        ...
        in
        super.h5py.overridePythonAttrs (old: old // lib.optionalAttrs (old.format != "wheel") {
          nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ pkg-config ];
          buildInputs = (old.buildInputs or [ ]) ++ [
            pkgs.hdf5
            self.pkgconfig
          ...
          propagatedBuildInputs = (old.propagatedBuildInputs or [ ]) ++ lib.optionals mpiSupport [
            self.mpi4py
            self.openssh
          ];
      ...
      hid = super.hid.overridePythonAttrs (_: {
        postPatch = ''
          found=
      ...
      importlib-metadata = super.importlib-metadata.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ]) ++
          lib.optionals self.python.isPy2 [ self.pathlib2 ];
      });

      intreehooks = super.intreehooks.overridePythonAttrs (_: {
        doCheck = false;
      });
      ...
      jupyter = super.jupyter.overridePythonAttrs (_: {
      ...
      mypy = super.mypy.overridePythonAttrs (old: {
        ...
        ] ++ lib.optionals (lib.strings.versionAtLeast old.version "0.990") [
          self.types-psutil
        ];
      ...
      pdal = super.pdal.overridePythonAttrs (_: {
      ...
      peewee = super.peewee.overridePythonAttrs (old:
        ...
        in
        {
          ...
          propagatedBuildInputs = (old.propagatedBuildInputs or [ ]) ++ lib.optionals withPostgres [
            self.psycopg2
      ...
      pillow = super.pillow.overridePythonAttrs (old:
        ...
        in
        {
          nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ pkg-config self.pytest-runner ];
      ...
      pygame = super.pygame.overridePythonAttrs (old: rec {
        nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ pkg-config pkgs.SDL ];
      ...
      pyproj = super.pyproj.overridePythonAttrs (_: {
        PROJ_DIR = "${pkgs.proj}";
      ...
      pytoml = super.pytoml.overridePythonAttrs (_: {
        doCheck = false;
      });
      ...
      pytest-datadir = super.pytest-datadir.overridePythonAttrs (_: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });
      ...
      pytest-django = super.pytest-django.overridePythonAttrs (_: {
        postPatch = ''
      ...
      pyusb = super.pyusb.overridePythonAttrs (_: {
        postPatch = ''
      ...
      rockset = super.rockset.overridePythonAttrs (_: {
        postPatch = ''
      ...
      tensorflow = super.tensorflow.overridePythonAttrs (_: {
        postInstall = ''
          rm $out/bin/tensorboard
        '';
      });

      tensorflow-macos = super.tensorflow-macos.overridePythonAttrs (_: {
        inherit (self.tensorflow) postInstall;
      });

      tensorpack = super.tensorpack.overridePythonAttrs (_: {
        postPatch = ''
      ...
      vose-alias-method = super.vose-alias-method.overridePythonAttrs (_: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });
      ...
      tqdm = super.tqdm.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ super.toml ];
      });
      ...
      wcwidth = super.wcwidth.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ]) ++ lib.optionals self.isPy27 [
